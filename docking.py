...
#Definindo os navios (ln (comprimento), m (número de containers))
itens = [(6 ,20), (5 ,12) ,(1 ,11) ,(1 ,55),(3 ,22),
         (8 ,80), (2 ,65) ,(3 ,27) ,(7 ,95),(17,28),
         (8,39) , (2,86)  ,(14,8)  ,(5,84) ,(4,92) ,
         (3,73) , (11,20) ,(3,14)  ,(3 ,20),(5 ,18),
         (2 ,13), (8 ,35) ,(10 ,37),(7 ,78),(3 ,55)]

#Comprimento máximo do cais
L_max = 50 

#Calcula valor de validacao com brute force
# t0 = time.time()
# best = run_bruteforce(itens, L_max)
# t1 = time.time()
